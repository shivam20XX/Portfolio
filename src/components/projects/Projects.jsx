    ...
    >
      ...
      <div className="grid gap-12 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {projects.map((project) => (
          <div
            key={project.id}
            className="border border-white bg-gray-900 backdrop-blur-md rounded-2xl overflow-hidden cursor-pointer hover:shadow-violet-500/50 hover:translate-y-2 transition-transform duration-300 "
          >
            <div>
              <img
                src={project.image}
            ...
            <div className="p-6 ">
              ...
              <p className="text-gray-400 mb-4 pt-4 line-clamp-4">
                {project.description}
              </p>
              <div className="mb-4">
